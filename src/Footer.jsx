...
function Footer() {
  return (
    ...
    <h1 className='text-[8vw] font-semibold uppercase leading-none mb-9'>
        Presentation          
        <div className="dets font-['Neue_Montreal'] justify-between mb-10 mt-100 flex">        
            <a className='block text-xl font-light hover:opacity-80 transition-opacity' target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/rajeev_das-07">Instagram</a>
            <a className='block text-xl font-light hover:opacity-80 transition-opacity' target="_blank" rel="noopener noreferrer" href="https://x.com/rajeev_das_0747">Twitter</a>
        </div>
        </h1>
    </div>
    </div>
