...
function Footer() {
  return (
    <div className="flex gap-5 w-full h-screen bg-zinc-900 p-20 font-['Founders_Grotesk_X_Condensed']">
        ...
        <h1 className='text-[16vw] md:text-[10vw] uppercase leading-none -mb-6 md:-mb-10'>Eye-</h1>
        <h1 className='text-[16vw] md:text-[10vw] uppercase leading-none -mb-6 md:-mb-10'>Opening</h1>
        </div>
        <svg 
    ...
    <div className="w-1/2">
    <h1 className='text-[12vw] md:text-[8vw] font-semibold uppercase leading-none mb-9'>
        Presentation          
        <div className="dets font-['Neue_Montreal'] justify-between mb-10 mt-100 flex gap-6 md:gap-0">        
            <a className='block  text-lg md:text-xl font-light justify-center' href="#">Facebook</a>
            <a className='block text-lg md:text-xl font-light' href="#">Instagram</a>
            <a className='block text-lg md:text-xl font-light' href="#">Twitter</a>
        </div>
        </h1>
    </div>
    </div>
